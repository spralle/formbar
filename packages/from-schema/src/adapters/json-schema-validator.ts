...
import { type JsonSchema, dereferenceSchema } from "@scheman/core";
...
function validateStringConstraints(
	...
	if (schema.format === "date" && !validateFormatDate(value)) {
		issues.push(makeIssue("INVALID_FORMAT", 'String must match format "date"', segments, stage));
	}
}
